...
<head>
    ...
    <header class="top-header" style='z-index: 1;'>
        <nav class="top-nav">
            ...
            <li><p class='button registrati'>Ristoratore</p></li>
    ...
    <div class="marginLR">
    <br><br>
    <button class='button aggiungi-ristorante'>Aggiungi un nuovo ristorante</button>
	<br><br>
    <button class='button visualizza-ristoranti'>Visualizza i miei ristoranti</button>
    <br>
    <br>
    <div id='pannello-ristorante'></div>
    <dl>
